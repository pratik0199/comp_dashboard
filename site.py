...
excel_file = pd.ExcelFile(r'https://github.com/pratik0199/comp_dashboard/blob/main/GERC_A_PARA_GUI_rev4.xlsm',engine='openpyxl')
...
database_df = pd.read_excel(r'https://github.com/pratik0199/comp_dashboard/blob/main/GERC_A_PARA_GUI_rev4.xlsmm',engine='openpyxl', sheet_name='database')
...
def load_data():
    return pd.read_excel(r'https://github.com/pratik0199/comp_dashboard/blob/main/GERC_A_PARA_GUI_rev4.xlsm', sheet_name='cur_data')
